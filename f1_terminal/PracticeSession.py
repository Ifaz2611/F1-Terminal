...
def main():
    ...
    print(f"\nLoading: {year} {track['country']} GP - {session_type['name']}")
    print("This may take a moment...")
    
    # Load session
    session = fastf1.get_session(year, track['country'], session_type['code'])
    session.load()
    ...
    ax.set_aspect('equal')
    ax.set_title(f"All Drivers' Fastest Laps - {year} {track['country']} GP {session_type['name']}",
